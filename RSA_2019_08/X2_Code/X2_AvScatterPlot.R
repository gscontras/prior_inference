...
#x2pilotData <- read.csv("x2pilotDataAugmfixed_opt12or123_2019_0114.csv")
#x2pilotData <- read.csv("x2pilot_DataCrossValAugmentedfixed_2019_0429.csv")
#x2pilotData <- read.csv("x2pilot_DataCrossValAugmented1notObey.1_2019_0429.csv")
#x2pilotData <- read.csv("x2pilot_DataCrossValAugmented23_2019_0429.csv")
#x2pilotData <- read.csv("x2pilot_DataCrossValAugmented1notObey.1_2019_0513.csv")
#x2pilotData <- read.csv("x2pilot_DataCrossValAugmented2orFixed00.1_2019_0513.csv")
#x2pilotData <- read.csv("x2pilot_DataCrossValSimpleModelAugmented_2019_0502.csv")
#x2pilotData <- read.csv("x2pilotDataAugmGlobal1or2_2019_05_15.csv")
#x2pilotData <- read.csv("x2pilotDataAugmGlobal1plusObeyAnd12_2019_05_15.csv")
#x2pilotData <- read.csv("x2pilotDataAugmGlobalfixed001AndAllThree_2019_05_15.csv")
#x2pilotData <- read.csv("x2pilotDataAugmGlobalSimpleRSA1or2_2019_05_15.csv")
x2pilotData <- read.csv("X2_Data/x2pilotDataAugmGlobalSimpleRSA1plusObeyAnd12_2019_05_15.csv")
...
#write.csv(x2pilotData, "X2_Data/x2pilotDataModelOptimizedSorted.csv")
