...
llWorkers12 <- as.matrix(read.csv("X2_Data/x2ModelsKLDivs_2019_0114.csv"))
paramsWorkers12 <- as.matrix(read.csv("X2_Data/x2ModelsOptParams_2019_0114.csv"))
...
write.csv(x2pilotData, "X2_Data/x2pilotDataAugmfixed_opt1or2_2019_0114.csv")
