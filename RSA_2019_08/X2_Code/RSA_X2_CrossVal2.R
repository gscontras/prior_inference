...
if(processType==2) {
  paramsWorkers1 <- as.matrix(read.csv("X2_Data/x2CrossVal_Params_1parOpt_2019_0430.csv")) 
  paramsWorkers1notObey.1 <- as.matrix(read.csv("X2_Data/x2CrossVal_Params_notObey.1_2019_0430.csv"))
  ...
  paramsWorkers12 <- as.matrix(read.csv("X2_Data/x2CrossVal_Params_12parOpt_2019_0430.csv"))
...
if(processType==1) {
  write.csv(x2pilotData, "X2_Data/x2pilot_DataCrossValAugmentedfixed_2019_0429.csv")
}else if(processType==2) {
  write.csv(x2pilotData, "X2_Data/x2pilot_DataCrossValAugmented1notObey.1_2019_0429.csv")
}else if(processType==3) {
  write.csv(x2pilotData, "X2_Data/x2pilot_DataCrossValAugmented23_2019_0429.csv")
}
