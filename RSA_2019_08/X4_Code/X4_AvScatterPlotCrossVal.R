...
#x4pilotData <- read.csv("X4_Data/x4pilot_SimpleRSA_DataCrossValAugmentedfixed_2019_0429.csv")
#x4pilotData <- read.csv("X4_Data/x4pilot_SimpleRSA_DataCrossValAugmented_2019_0507.csv")
x4pilotData <- read.csv("X4_Data/x4pilot_SimpleRSA_DataCrossValAugmented2_2019_0507.csv")

#x4pilotData <- read.csv("X4_Data/x4pilot_DataCrossValAugmentedfixed_2019_0429.csv")
#x4pilotData <- read.csv("X4_Data/x4pilot_DataCrossValAugmented_2019_0429.csv")
#x4pilotData <- read.csv("X4_Data/x4pilot_DataCrossValAugmented_notObey.1_2019_0429.csv")
#x4pilotData <- read.csv("X4_Data/x4pilot_DataCrossValAugmented23_2019_0429.csv")
...
for(i in c(1:length(myCCodes))) {
  ...
  ccSpecificTrials <- x4pilotData[cases,]
  for(j in c(1:9)) {
