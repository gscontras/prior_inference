...
#################################################
paramsWorkers12 <- as.matrix(read.csv("X4_Data/x4Params_simpleRSA_globalOpt_2019_1009.csv"))
...
if(procType == 1) {
write.csv(x4pilotData, "X4_Data/x4pDataAugm_SRSAglobaOpt_fixed.1.1_and_OptPrefobedFixed.1.csv")
}else if(procType == 2) {
  write.csv(x4pilotData, "X4_Data/x4pDataAugm_SRSAglobalOpt_OptPrefObedFixed0_and_Opt12.csv")
}
