...
x4pilotData <- read.csv("X4_Data/x4pilot_DataCrossValSimpleModelAugmented_2019_0502.csv")
...
print("Simple Choice-Based 1 Parameter Model")
...
print("Simple Choice-Based 2 Parameter Model")
