...
write.csv(klDivUttWorkers, "X8_Data/KLDivUttWorkers_x8_UttChoiceSimpleRSAFTF_2019_06_17.csv")
write.csv(paramsUttWorkers, "X8_Data/KLDivUttParamsWorkers_x8_UttChoiceSimpleRSAFTF_2019_06_17.csv")
