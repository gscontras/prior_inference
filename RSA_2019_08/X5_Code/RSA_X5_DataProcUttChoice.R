...
write.csv(klDivUttWorkers, "X5_Data/KLDivUttWorkers_x5_UttChoice_2019_05_29.csv")
write.csv(paramsUttWorkers, "X5_Data/KLDivUttParamsWorkers_x5_UttChoice_2019_05_29.csv")
