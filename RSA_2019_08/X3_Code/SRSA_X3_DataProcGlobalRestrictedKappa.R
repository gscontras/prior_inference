...
optRes3 <- optimize(SimpleRSAModelUttKLDivParamK, c(0,10), dataWorker)   
...
####
write.csv(klDivUttWorkers, "X3_Data/x3KLDivs_simpleRSA_globalOpt_posKappa_2020_08_19.csv")
write.csv(paramsUttWorkers, "X3_Data/x3Params_simpleRSA_globalOpt_posKappa_2020_08_19.csv")
