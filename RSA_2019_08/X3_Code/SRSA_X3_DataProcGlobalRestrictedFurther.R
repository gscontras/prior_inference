...
paramsUttWorkers <- as.matrix(read.csv("X3_Data/x3Params_simpleRSA_globalOpt_posKappa_2020_08_19.csv"))
...
if(procType == 1) {
  write.csv(x3pilotData, "X3_Data/x3pDataAugm_simpleRSAglobalOpt_posKappa_kappaOnly_and_obedAndKappa.csv")
}else if(procType == 2) {
  write.csv(x3pilotData, "X3_Data/x3pDataAugm_simpleRSAglobalOpt_posKappa_prefAndKappa_and_prefObedAndKappa.csv")
}
