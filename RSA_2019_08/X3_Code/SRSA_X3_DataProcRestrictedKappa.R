...
write.csv(klDivUttWorkers, "X3_Data/x3KLDivs_simpleRSA_indOpt_posKappa_2020_08_15.csv")
write.csv(paramsUttWorkers, "X3_Data/x3Params_simpleRSA_indOpt_posKappa_2020_08_15.csv")
