...
write.csv(klDivUttWorkers, "X6_Data/KLDivUttWorkers_x6_UttChoice_2019_05_29.csv")
write.csv(paramsUttWorkers, "X6_Data/KLDivUttParamsWorkers_x6_UttChoice_2019_05_29.csv")
