...
klDivUttWorkers <- as.matrix(read.csv("X6_Data/KLDivUttWorkers_x6_UttChoice_2019_05_29.csv"))
klDivUttWorkers <- klDivUttWorkers[ , 2:ncol(klDivUttWorkers)]
paramsUttWorkers <- as.matrix(read.csv("X6_Data/KLDivUttParamsWorkers_x6_UttChoice_2019_05_29.csv"))
...
#write.csv(x6pilotData, "X6_Data/x6pilotDataAugm_UttChoice_RSA_fixedAndD_2019_05_29.csv")
#write.csv(x6pilotData, "X6_Data/x6pilotDataAugm_UttChoice_RSA_ADandBD_052019.csv")
write.csv(x6pilotData, "X6_Data/x6pilotDataAugm_UttChoice_RSA_ABandABD_052019.csv")
