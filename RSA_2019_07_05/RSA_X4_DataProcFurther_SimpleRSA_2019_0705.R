...
#################################################
llWorkers12 <- as.matrix(read.csv("x4SimpleRSAModelsKLDivs_2019_0705.csv"))
paramsWorkers12 <- as.matrix(read.csv("x4SimpleRSAModelsOptParams_2019_0705.csv"))
...
if(procType == 1) {
write.csv(x4pilotData, "x4pilotDataAugm_SimpleRSA_fixed.20_.2.2_2019_07_05.csv")
}else if(procType == 2) {
  write.csv(x4pilotData, "x4pilotDataAugm_SimpleRSA_prefOpt0and.2forobey_2019_07_05.csv")
}else if(procType == 3) {
  write.csv(x4pilotData, "x4pilotDataAugm_SimpleRSA_obejOpt0and.2forpref_2019_07_05.csv")
}else if(procType == 4) {
  write.csv(x4pilotData, "x4pilotDataAugm_SimpleRSA_fixed00_prefAndObejOpt_2019_07_05.csv")
}
