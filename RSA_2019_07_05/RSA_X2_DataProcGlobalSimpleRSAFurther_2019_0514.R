...
#                                                       0, abs(params2only[1]))
  postListMat1Opt[i,] <- determineSpeakerPostListPrefsSimpleRSA(objectConstellation, featChoice,
                                                       abs(params1only.1obeyInst[1]), 0.1)
  postListMat2Opt[i,] <- determineSpeakerPostListPrefsSimpleRSA(objectConstellation, featChoice,
...
#write.csv(x2pilotData, "x2pilotDataAugmGlobalSimpleRSA1or2_2019_05_15.csv")
write.csv(x2pilotData, "x2pilotDataAugmGlobalSimpleRSA1plusObeyAnd12_2019_05_15.csv")
