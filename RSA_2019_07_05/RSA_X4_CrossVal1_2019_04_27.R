...
## writing out tables
if(parOptType==1) {
  write.csv(llWorkers12, "x4CrossVal_KLDivOpt_1parOpt_2019_0430.csv")
  write.csv(paramsWorkers12, "x4CrossVal_Params_1parOpt_2019_0430.csv")
  write.csv(klDivCrossValValues, "x4CrossVal_KLDivTrial_1parOpt_2019_0430.csv")
}else if(parOptType==2) {
  write.csv(llWorkers12, "x4CrossVal_KLDivOpt_12parOpt_2019_0430.csv")
  write.csv(paramsWorkers12, "x4CrossVal_Params_12parOpt_2019_0430.csv")
  write.csv(klDivCrossValValues, "x4CrossVal_KLDivTrial_12parOpt_2019_0430.csv")
}else if(parOptType==3) {
  write.csv(llWorkers12, "x4CrossVal_KLDivOpt_123parOpt_2019_0430.csv")
  write.csv(paramsWorkers12, "x4CrossVal_Params_123parOpt_2019_0430.csv")
  write.csv(klDivCrossValValues, "x4CrossVal_KLDivTrial_123parOpt_2019_0430.csv")
}
