...
x5pilotData <- read.csv("5-combined-unique.csv")
...
klDivUttWorkers <- as.matrix(read.csv("KLDivUttWorkers_x5_UttChoice_2019_05_29.csv"))
klDivUttWorkers <- klDivUttWorkers[ , 2:ncol(klDivUttWorkers)]
paramsUttWorkers <- as.matrix(read.csv("KLDivUttParamsWorkers_x5_UttChoice_2019_05_29.csv"))
paramsUttWorkers <- paramsUttWorkers[ , 2:ncol(paramsUttWorkers)]

#klDivUttWorkers <- as.matrix(read.csv("KLDivUttWorkersWith.2_x5_2019_05_16.csv"))
#klDivUttWorkers <- klDivUttWorkers[ , 2:ncol(klDivUttWorkers)]
#paramsUttWorkers <- as.matrix(read.csv("KLDivUttParamsWorkersWith.2_x5_2019_05_16.csv"))
#paramsUttWorkers <- paramsUttWorkers[ , 2:ncol(paramsUttWorkers)]
...
write.csv(x5pilotData, "x5pilotDataAugm_UttChoice_fixedAndD_2019_05_29.csv")

#write.csv(x5pilotData, "x5pilotDataAugm_ADandBD_052019.csv")
#write.csv(x5pilotData, "x5pilotDataAugm_ABandABD_052019.csv")
