...
source("RSA_UttChoiceOptimization_2019_0516.R")
...
klDivUttWorkers <- as.matrix(read.csv("KLDivUttWorkers_x6_UttChoice_2019_05_29.csv"))
klDivUttWorkers <- klDivUttWorkers[ , 2:ncol(klDivUttWorkers)]
paramsUttWorkers <- as.matrix(read.csv("KLDivUttParamsWorkers_x6_UttChoice_2019_05_29.csv"))
paramsUttWorkers <- paramsUttWorkers[ , 2:ncol(paramsUttWorkers)]

#klDivUttWorkers <- as.matrix(read.csv("KLDivUttWorkersWith.2_x6_2019_05_16.csv"))
#klDivUttWorkers <- klDivUttWorkers[ , 2:ncol(klDivUttWorkers)]
#paramsUttWorkers <- as.matrix(read.csv("KLDivUttParamsWorkersWith.2_x6_2019_05_16.csv"))
#paramsUttWorkers <- paramsUttWorkers[ , 2:ncol(paramsUttWorkers)]
...
write.csv(x6pilotData, "x6pilotDataAugm_UttChoice_fixedAndD_2019_05_29.csv")

#write.csv(x6pilotData, "x6pilotDataAugm_ADandBD_052019.csv")
#write.csv(x6pilotData, "x6pilotDataAugm_ABandABD_052019.csv")
