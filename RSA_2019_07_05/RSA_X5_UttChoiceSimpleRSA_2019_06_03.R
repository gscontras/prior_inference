...
write.csv(klDivUttWorkers, "KLDivUttWorkers_x5_UttChoiceSimpleRSA_2019_06_03.csv")
write.csv(paramsUttWorkers, "KLDivUttParamsWorkers_x5_UttChoiceSimpleRSA_2019_06_03.csv")
