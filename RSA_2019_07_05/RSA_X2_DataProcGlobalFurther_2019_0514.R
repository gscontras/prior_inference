...
#llWorkers12 <- as.matrix(read.csv("x2ModelsKLDivs_2019_0430.csv"))
paramsWorkers12 <- as.matrix(read.csv("x2ModelsOptParamsGlobal_2019_0514.csv"))
...
#write.csv(x2pilotData, "x2pilotDataAugmGlobal1or2_2019_05_15.csv")
#write.csv(x2pilotData, "x2pilotDataAugmGlobal1plusObeyAnd12_2019_05_15.csv")
write.csv(x2pilotData, "x2pilotDataAugmGlobalfixed001AndAllThree_2019_05_15.csv")
