...
x5UttChoiceData <- read.csv("x5pilotDataUttChoiceAugmented012019.csv")
...
modelGuessIndex1M1 <- grep("^MPost_1", colnames(x5UttChoiceData)) - 1
modelGuessIndex2M1 <- grep("^MPostNO_1", colnames(x5UttChoiceData)) - 1
...
modelGuessIndex1 <- grep("^MPost_1", colnames(x5UttChoiceData))
modelGuessIndex2 <- grep("^MPostNO_1", colnames(x5UttChoiceData))
