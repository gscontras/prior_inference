...
write.csv(llWorkers12, "x4ModelsKLDivsGlobal_2019_0512.csv")
write.csv(paramsWorkers12, "x4ModelsOptParamsGlobal_2019_0512.csv")
...
# 
# write.csv(x4pilotData, "x4pilotDataAugmented_2019_04_30.csv")
# 
# 
# 
# 
