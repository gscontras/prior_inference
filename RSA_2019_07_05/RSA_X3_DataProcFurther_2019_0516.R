...
klDivUttWorkers <- as.matrix(read.csv("KLDivUttWorkers_x3_2019_05_27.csv"))
klDivUttWorkers <- klDivUttWorkers[ , 2:ncol(klDivUttWorkers)]
paramsUttWorkers <- as.matrix(read.csv("KLDivUttParamsWorkers_x3_2019_05_27.csv"))
paramsUttWorkers <- paramsUttWorkers[ , 2:ncol(paramsUttWorkers)]

#klDivUttWorkers <- as.matrix(read.csv("KLDivUttWorkersWith.2_x3_2019_05_16.csv"))
#klDivUttWorkers <- klDivUttWorkers[ , 2:ncol(klDivUttWorkers)]
#paramsUttWorkers <- as.matrix(read.csv("KLDivUttParamsWorkersWith.2_x3_2019_05_16.csv"))
#paramsUttWorkers <- paramsUttWorkers[ , 2:ncol(paramsUttWorkers)]
...
write.csv(x3pilotData, "x3pilotDataAugm_fixedAndD_052019.csv")

#write.csv(x3pilotData, "x3pilotDataAugm_ADandBD_052019.csv")
#write.csv(x3pilotData, "x3pilotDataAugm_ABandABD_052019.csv")
