...
#x4pilotData <- read.csv("x4pilotDataAugmGlobal12_2019_04_30.csv")

#x4pilotData <- read.csv("x4pilotDataAugm_SimpleRSA_fixed.20_.2.2_2019_07_05.csv")
#x4pilotData <- read.csv("x4pilotDataAugm_SimpleRSA_prefOpt0and.2forobey_2019_07_05.csv")
#x4pilotData <- read.csv("x4pilotDataAugm_SimpleRSA_obejOpt0and.2forpref_2019_07_05.csv")
x4pilotData <- read.csv("x4pilotDataAugm_SimpleRSA_fixed00_prefAndObejOpt_2019_07_05.csv")
