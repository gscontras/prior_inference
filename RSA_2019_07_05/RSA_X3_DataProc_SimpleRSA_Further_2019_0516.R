...
klDivUttWorkers <- as.matrix(read.csv("KLDivUttWorkers_x3_UttChoiceSimpleRSA_2019_06_03.csv"))
klDivUttWorkers <- klDivUttWorkers[ , 2:ncol(klDivUttWorkers)]
paramsUttWorkers <- as.matrix(read.csv("KLDivUttParamsWorkers_x3_UttChoiceSimpleRSA_2019_06_03.csv"))
