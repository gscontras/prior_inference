...
llWorkers12 <- as.matrix(read.csv("x4ModelsKLDivs_2019_0114.csv"))
paramsWorkers12 <- as.matrix(read.csv("x4ModelsOptParams_2019_0114.csv"))
...
write.csv(x4pilotData, "x4pilotDataAugmPar1and2_2019_0114.csv")
