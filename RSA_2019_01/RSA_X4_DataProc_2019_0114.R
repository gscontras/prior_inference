...
write.csv(llWorkers12, "x4ModelsKLDivs_2019_0114.csv")
write.csv(paramsWorkers12, "x4ModelsOptParams_2019_0114.csv")
...
write.csv(x4pilotData, "x4pilotDataAugmented_2019_0114.csv")
