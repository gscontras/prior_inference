...
#write.csv(x2pilotData, "X2_Data/x2pilotDataAugmGlobalSimpleRSA1or2_2019_05_15.csv")
write.csv(x2pilotData, "X2_Data/x2pilotDataAugmGlobalSimpleRSA1plusObeyAnd12_2019_05_15.csv")
