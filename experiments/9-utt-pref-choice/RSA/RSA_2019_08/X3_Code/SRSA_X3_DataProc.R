...
write.csv(klDivUttWorkers, "X3_Data/KLDivUttWorkers_x3_UttChoiceSimpleRSA_2019_06_03.csv")
write.csv(paramsUttWorkers, "X3_Data/KLDivUttParamsWorkers_x3_UttChoiceSimpleRSA_2019_06_03.csv")
