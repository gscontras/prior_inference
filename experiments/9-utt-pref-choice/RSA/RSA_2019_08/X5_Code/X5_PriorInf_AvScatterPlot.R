...
#x5pilotData <- read.csv("X5_Data/x5priorInfDataAugmPar1and2.csv")
#x5pilotData <- read.csv("X5_Data/x5priorInfDataAugm_SimpleRSA_P1or2_2019_05_17.csv")
x5pilotData <- read.csv("X5_Data/x5priorInfDataAugm_SimpleRSA_P1no.1or.2_2019_05_17.csv")
#x5pilotData <- read.csv("X5_Data/x5priorInfDataAugm_SimpleRSA_P2pref.2andP12_2019_05_17.csv")
