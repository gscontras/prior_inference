...
write.csv(klDivUttWorkers, "X6_Data/KLDivUttWorkers_x6_UttChoiceSimpleRSA_2019_06_03.csv")
write.csv(paramsUttWorkers, "X6_Data/KLDivUttParamsWorkers_x6_UttChoiceSimpleRSA_2019_06_03.csv")
