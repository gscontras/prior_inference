...
function make_slides(f) {
  ...
  slides.comparison = slide({
    ...
    start: function () {
      ...
      // switch(guessRank){
      //   case simRank: evalNum = 3;
      //   console.log(simRank + "simRank");
      //   break;
      //   case [simRank[0], simRank[2], simRank[1]]: evalNum = 2;
      //   console.log([simRank[0], simRank[2], simRank[1]] + "[simRank[1], simRank[3], simRank[2]]");
      //   break;
      //   case [simRank[1], simRank[0], simRank[2]]: evalNum = 2;
      //   console.log([simRank[1], simRank[0], simRank[2]] + "[simRank[2], simRank[1], simRank[3]]");
      //   break;
      //   case [simRank[1], simRank[2], simRank[0]]: evalNum = 1;
      //   console.log([simRank[1], simRank[2], simRank[0]] + "[simRank[2], simRank[3], simRank[1]]");
      //   break;
      //   case [simRank[2], simRank[0], simRank[1]]: evalNum = 1;
      //   console.log([simRank[2], simRank[0], simRank[1]] + "[simRank[3], simRank[1], simRank[2]]");
      //   break;
      //   case [simRank[2], simRank[1], simRank[0]]: evalNum = 0;
      //   console.log([simRank[2], simRank[1], simRank[0]] + "[simRank[3], simRank[2], simRank[1]]");
      //   break;
      //   default: console.log( "Looking forward to the Weekend");
      // };

      // for (var i = 0; i < 3; i++) {
      //   console.log("\"" + guessRank[i] + "\" \"" + simRank[i] + "\"")
      //   if (simRank[i] == guessRank[i]) {
      //     evalNum++;
      //     console.log("rank " + i)
      //   }
      // };
