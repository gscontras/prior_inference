...
function make_slides(f) {
  ...
  slides.multi_slider = slide({
    ...
    log_responses : function() {
      exp.data_trials.push({
        ...
        "item" : this.stim.ID,
        "itemCode" : this.stim.priorInfCode,
  ...
  slides.utterance_choice = slide({
    ...
    present_handle : function(stim) {
      ...
      this.order = _.shuffle([0,1,2])

      var object1 = "<img src='images/" + stim.item[this.order[0]] + ".png' width='120'></img>"
      var object2 = "<img src='images/" + stim.item[this.order[1]] + ".png' width='120'></img>"
      var object3 = "<img src='images/" + stim.item[this.order[2]] + ".png' width='120'></img>"
