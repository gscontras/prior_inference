...
## writing out tables
if(parOptType==1) {
#  write.csv(llWorkers12, "x4CrossVal_SimpleRSA_KLDivOpt_1parOpt_2019_0430.csv")
#  write.csv(paramsWorkers12, "x4CrossVal_SimpleRSA_Params_1parOpt_2019_0430.csv")
#  write.csv(klDivCrossValValues, "x4CrossVal_SimpleRSA_KLDivTrial_1parOpt_2019_0430.csv")

  write.csv(llWorkers12, "x4CrossVal_SimpleRSA_KLDivOpt_notObey.1_2019_0430.csv")
  write.csv(paramsWorkers12, "x4CrossVal_SimpleRSA_Params_notObey.1_2019_0430.csv")
  write.csv(klDivCrossValValues, "x4CrossVal_SimpleRSA_KLDivTrial_notObey.1_2019_0430.csv")
}else if(parOptType==2) {
  write.csv(llWorkers12, "x4CrossVal_SimpleRSA_KLDivOpt_12parOpt_2019_0430.csv")
  write.csv(paramsWorkers12, "x4CrossVal_SimpleRSA_Params_12parOpt_2019_0430.csv")
  write.csv(klDivCrossValValues, "x4CrossVal_SimpleRSA_KLDivTrial_12parOpt_2019_0430.csv")
}
