...
source("RSA_StratUtt_NonRSASimpleModel_2019_04_29.R")
...
## writing out tables
if(numParams==1) {
  write.csv(klDivWorkers, "x4CrossVal_KLDivOpt_SimpleModel_2019_0430.csv")
  write.csv(paramsWorkers, "x4CrossVal_Params_SimpleModel_2019_0430.csv")
  write.csv(klDivCrossValValues, "x4CrossVal_KLDivTrial_SimpleModel_2019_0430.csv")
}else{
  write.csv(klDivWorkers, "x4CrossVal_KLDivOpt_SimpleModel2p_2019_0430.csv")
  write.csv(paramsWorkers, "x4CrossVal_Params_SimpleModel2p_2019_0430.csv")
  write.csv(klDivCrossValValues, "x4CrossVal_KLDivTrial_SimpleModel2p_2019_0430.csv")
