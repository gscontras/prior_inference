...
#paramsWorkers1 <- as.matrix(read.csv("x4CrossVal_SimpleRSA_Params_1parOpt_2019_0430.csv"))
#paramsWorkers1 <- paramsWorkers1[,c(2:ncol(paramsWorkers1))]
#paramsWorkers1notObey.1 <- as.matrix(read.csv("x4CrossVal_SimpleRSA_Params_notObey.1_2019_0430.csv"))
#paramsWorkers1notObey.1 <- paramsWorkers1notObey.1[,c(2:ncol(paramsWorkers1notObey.1))]

paramsWorkers12 <- as.matrix(read.csv("x4CrossVal_SimpleRSA_Params_12parOpt_2019_0430.csv"))
...
#write.csv(x4pilotData, "x4pilot_SimpleRSA_DataCrossValAugmentedfixed_2019_0429.csv")
#write.csv(x4pilotData, "x4pilot_SimpleRSA_DataCrossValAugmented_2019_0507.csv")
write.csv(x4pilotData, "x4pilot_SimpleRSA_DataCrossValAugmented2_2019_0507.csv")
