...
## writing out tables
if(parOptType==1) {
  write.csv(llWorkers12, "x2CrossVal_KLDivOpt_1parOpt_2019_0430.csv")
  write.csv(paramsWorkers12, "x2CrossVal_Params_1parOpt_2019_0430.csv")
  write.csv(klDivCrossValValues, "x2CrossVal_KLDivTrial_1parOpt_2019_0430.csv")
}else if(parOptType==2) {
  write.csv(llWorkers12, "x2CrossVal_KLDivOpt_12parOpt_2019_0430.csv")
  write.csv(paramsWorkers12, "x2CrossVal_Params_12parOpt_2019_0430.csv")
  write.csv(klDivCrossValValues, "x2CrossVal_KLDivTrial_12parOpt_2019_0430.csv")
}else if(parOptType==3) {
  write.csv(llWorkers12, "x2CrossVal_KLDivOpt_123parOpt_2019_0430.csv")
  write.csv(paramsWorkers12, "x2CrossVal_Params_123parOpt_2019_0430.csv")
  write.csv(klDivCrossValValues, "x2CrossVal_KLDivTrial_123parOpt_2019_0430.csv")
}else if(parOptType==4) {
  write.csv(llWorkers12, "x2CrossVal_KLDivOpt_notObey.1_2019_0430.csv")
  write.csv(paramsWorkers12, "x2CrossVal_Params_notObey.1_2019_0430.csv")
  write.csv(klDivCrossValValues, "x2CrossVal_KLDivTrial_notObey.1_2019_0430.csv")
}
