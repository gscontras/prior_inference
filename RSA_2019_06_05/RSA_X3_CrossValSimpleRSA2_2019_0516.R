...
if(parOptType == 12) {
  paramsUttWorkers1 <- as.matrix(read.csv("x3CrossVal_SimpleRSA_Params_ObedPar_2019_0516.csv"))
  paramsUttWorkers1 <- paramsUttWorkers1[ , 2:ncol(paramsUttWorkers1)]
  paramsUttWorkers2 <- as.matrix(read.csv("x3CrossVal_SimpleRSA_Params_ObedAndKPars_2019_0516.csv"))
  paramsUttWorkers2 <- paramsUttWorkers2[ , 2:ncol(paramsUttWorkers2)]
}else if(parOptType == 34) {
  paramsUttWorkers3 <- as.matrix(read.csv("x3CrossVal_SimpleRSA_Params_PrefAndKPars_2019_0516.csv"))
  paramsUttWorkers3 <- paramsUttWorkers3[ , 2:ncol(paramsUttWorkers3)]
  paramsUttWorkers4 <- as.matrix(read.csv("x3CrossVal_SimpleRSA_Params_PrefObedKPars_2019_0516.csv"))
...
if(parOptType==12) {
  write.csv(x3pilotData, "x3pilotDataAugm_CrossVal_SimpleRSA_Opt12_2019_05_17.csv")
}else if(parOptType==34) {
  write.csv(x3pilotData, "x3pilotDataAugm_CrossVal_SimpleRSA_Opt34_2019_05_17.csv")
}
