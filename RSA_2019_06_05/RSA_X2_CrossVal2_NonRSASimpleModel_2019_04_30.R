...
paramsWorkers1 <- as.matrix(read.csv("x2CrossVal_Params_SimpleModel_2019_0430.csv"))
paramsWorkers1 <- paramsWorkers1[,c(2:ncol(paramsWorkers1))]

paramsWorkers2 <- as.matrix(read.csv("x2CrossVal_Params_SimpleModel2p_2019_0430.csv"))
...
write.csv(x2pilotData, "x2pilot_DataCrossValSimpleModelAugmented_2019_0502.csv")
