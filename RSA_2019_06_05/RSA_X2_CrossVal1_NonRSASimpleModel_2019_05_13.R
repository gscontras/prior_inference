...
## writing out tables
if(numParams==1) {
  write.csv(klDivWorkers, "x2CrossVal_KLDivOpt_SimpleModel_2019_0430.csv")
  write.csv(paramsWorkers, "x2CrossVal_Params_SimpleModel_2019_0430.csv")
  write.csv(klDivCrossValValues, "x2CrossVal_KLDivTrial_SimpleModel_2019_0430.csv")
}else{
  write.csv(klDivWorkers, "x2CrossVal_KLDivOpt_SimpleModel2p_2019_0430.csv")
  write.csv(paramsWorkers, "x2CrossVal_Params_SimpleModel2p_2019_0430.csv")
  write.csv(klDivCrossValValues, "x2CrossVal_KLDivTrial_SimpleModel2p_2019_0430.csv")
