...
#llWorkers12 <- as.matrix(read.csv("x4ModelsKLDivs_2019_0430.csv"))
paramsWorkers12 <- as.matrix(read.csv("x4ModelsOptParamsGlobal_2019_0512.csv"))
...
write.csv(x4pilotData, "x4pilotDataAugmGlobal12_2019_04_30.csv")
