...
#paramsWorkers1 <- as.matrix(read.csv("x4CrossVal_Params_1parOpt_2019_0430.csv")) 
paramsWorkers1 <- as.matrix(read.csv("x4CrossVal_Params_notObey.1_2019_0429.csv"))
paramsWorkers1 <- paramsWorkers1[,c(2:ncol(paramsWorkers1))]
#paramsWorkers12 <- as.matrix(read.csv("x4CrossVal_Params_12parOpt_2019_0430.csv"))
#paramsWorkers123 <- as.matrix(read.csv("x4CrossVal_Params_123parOpt_2019_0430.csv"))
...
#write.csv(x4pilotData, "x4pilot_DataCrossValAugmentedfixed_2019_0429.csv")
write.csv(x4pilotData, "x4pilot_DataCrossValAugmented1notObey.1_2019_0429.csv")
#write.csv(x4pilotData, "x4pilot_DataCrossValAugmented23_2019_0429.csv")
