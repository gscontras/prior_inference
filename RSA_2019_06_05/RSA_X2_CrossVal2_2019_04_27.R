...
processType <- 3 # 1=fixed, 2=opt.pref.,obey/notObey.1; 3=2 or 3 params Optimized

## loading optimized trial-respective cross-validated parameter values 
if(processType==2) {
  paramsWorkers1 <- as.matrix(read.csv("x2CrossVal_Params_1parOpt_2019_0430.csv")) 
  paramsWorkers1notObey.1 <- as.matrix(read.csv("x2CrossVal_Params_notObey.1_2019_0430.csv"))
  ...
  paramsWorkers12 <- as.matrix(read.csv("x2CrossVal_Params_12parOpt_2019_0430.csv"))
  paramsWorkers123 <- as.matrix(read.csv("x2CrossVal_Params_123parOpt_2019_0430.csv"))
...
if(processType==1) {
  write.csv(x2pilotData, "x2pilot_DataCrossValAugmentedfixed_2019_0429.csv")
}else if(processType==2) {
  write.csv(x2pilotData, "x2pilot_DataCrossValAugmented1notObey.1_2019_0429.csv")
}else if(processType==3) {
  write.csv(x2pilotData, "x2pilot_DataCrossValAugmented23_2019_0429.csv")
}
