...
write.csv(llWorkers12, "x2ModelsKLDivsGlobalSimpleRSA_2019_0514.csv")
write.csv(paramsWorkers12, "x2ModelsOptParamsGlobalSimpleRSA_2019_0514.csv")
...
# 
# write.csv(x2pilotData, "x2pilotDataAugmented_2019_04_30.csv")
# 
# 
# 
# 
