...
write.csv(klDivUttWorkers, "KLDivUttWorkers_x6_UttChoiceSimpleRSA_2019_06_03.csv")
write.csv(paramsUttWorkers, "KLDivUttParamsWorkers_x6_UttChoiceSimpleRSA_2019_06_03.csv")
