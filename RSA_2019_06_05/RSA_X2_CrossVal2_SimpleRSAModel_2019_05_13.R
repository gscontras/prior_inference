...
if(processType==1) {
  paramsWorkers1 <- as.matrix(read.csv("x2CrossVal_SimpleRSA_Params_1parOpt_2019_0430.csv")) 
  paramsWorkers1notObey.1 <- as.matrix(read.csv("x2CrossVal_SimpleRSA_Params_notObey.1_2019_0430.csv"))
  ...
  paramsWorkers12 <- as.matrix(read.csv("x2CrossVal_SimpleRSA_Params_12parOpt_2019_0430.csv"))
...
if(processType==1) {
  write.csv(x2pilotData, "x2pilot_DataCrossValAugmented1notObey.1_2019_0513.csv")
}else if(processType==2) {
  write.csv(x2pilotData, "x2pilot_DataCrossValAugmented2orFixed00.1_2019_0513.csv")
}
