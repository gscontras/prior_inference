...
llWorkers12 <- as.matrix(read.csv("x2ModelsKLDivs_2019_0114.csv"))
paramsWorkers12 <- as.matrix(read.csv("x2ModelsOptParams_2019_0114.csv"))
...
write.csv(x2pilotData, "x2pilotDataAugmfixed_opt1or2_2019_0114.csv")
