...
We use ambiguity resolution as a paradigm in which learning about others is possible. Intuitively, ambiguity should make understanding each other difficult.
...
\subsection*{Modeling: Pragmatic social inference RSA}
...
We evaluate two versions of the model. fullPSIRSA assumes a rather deep reasoning process. fullPSIRSA essentially assumes that feature preference inference not only considers the current object choices possible, but also differentiates the choice options further with respect to their pragmatic plausibility. 
...
Recently, it has been shown that even in the original, simpler reference games, fewer layers of reasoning often perform equally well or better than more complex models \cite{sikos2019}. simplePSIRSA removes this reasoning about alternative utterances and allows the pragmatic speaker to directly tap into the (expected) interpretation of $L_0$, directly augmenting the literal listener's choice likelihoods with the feature-preference-dependent object prior $P(s\mid f)$:
...
We fit the following free parameters to optimized the predictions of the models. First, the full model includes a ``greedineess'' parameter $\alpha$ that controls how likely participants are to choose an optimal utterance to signal an object to a speaker. This parameter is absent in the simple model since it relies on fewer layers of reasoning. The second parameter $\gamma$ controls how soft the preferences are: if preferences are hard, participants will use values are the ends of the scale, while soft preferences will push the slider values towards the middle. Finally, the obedience parameter $\beta$ allows subjects to consider objects that do not qualify for the utterance, for example, subjects will consider objects that are not blue upon hearing ``blue''.
...
Here, both simplePSIRSA and fullPSIRSA with softness ($\gamma$) optimized globally provide nearly-identically good fits to the data.
...
Our next task is to check the predictions of our strategic utterance selection model: given a set of potential referents, are participants able to reason pragmatically about the utility of ambiguous utterances in informing listener preferences? Figure \ref{exp2-trial} shows a sample trial.
...
\begin{figure*}[!ht]
	...
	\begin{subfigure}[b]{\linewidth}
		\centering
		\begin{tikzpicture}
		\node[](o1) at (-2,0){\includegraphics[width=1.5cm]{appendix/311.png}};
		\node[](o2) at (0,0){\includegraphics[width=1.5cm]{appendix/211.png}};
		\node[](o3) at (2,0){\includegraphics[width=1.5cm]{appendix/313.png}};
	...
	\begin{subfigure}[b]{0.45\linewidth}
		\begin{tikzpicture}
		\node[](o1) at (-2,0){\includegraphics[width=1.5cm]{appendix/212.png}};
		\node[](o2) at (0,0){\includegraphics[width=1.5cm]{appendix/213.png}};
		\node[](o3) at (2,0){\includegraphics[width=1.5cm]{appendix/222.png}};
	...
	\begin{subfigure}[b]{0.45\linewidth}
		\begin{tikzpicture}
		\node[](o1) at (-2,0){\includegraphics[width=1.5cm]{appendix/131.png}};
		\node[](o2) at (0,0){\includegraphics[width=1.5cm]{appendix/112.png}};
		\node[](o3) at (2,0){\includegraphics[width=1.5cm]{appendix/111.png}};
...
\begin{figure*}[!ht]
	...
	\begin{subfigure}[b]{\linewidth}
		\centering
		\begin{tikzpicture}
		\node[](o1) at (-2,0){\includegraphics[width=1.5cm]{appendix/133.png}};
		\node[](o2) at (0,0){\includegraphics[width=1.5cm]{appendix/122.png}};
		\node[](o3) at (2,0){\includegraphics[width=1.5cm]{appendix/232.png}};
	...
	\begin{subfigure}[b]{0.45\linewidth}
		\begin{tikzpicture}
		\node[](o1) at (-2,0){\includegraphics[width=1.5cm]{appendix/212.png}};
		\node[](o2) at (0,0){\includegraphics[width=1.5cm]{appendix/221.png}};
		\node[](o3) at (2,0){\includegraphics[width=1.5cm]{appendix/311.png}};
...
\begin{figure*}[!ht]
	...
	\begin{subfigure}[b]{\linewidth}
		...
		\node[](o1) at (-2,0){\includegraphics[width=1.5cm]{appendix/131.png}};
		\node[](o2) at (0,0){\includegraphics[width=1.5cm]{appendix/221.png}};
		\node[](o3) at (2,0){\includegraphics[width=1.5cm]{appendix/231.png}};
	...
	\begin{subfigure}[b]{0.45\linewidth}
		\begin{tikzpicture}
		\node[](o1) at (-2,0){\includegraphics[width=1.5cm]{appendix/123.png}};
		\node[](o2) at (0,0){\includegraphics[width=1.5cm]{appendix/122.png}};
		\node[](o3) at (2,0){\includegraphics[width=1.5cm]{appendix/112.png}};
