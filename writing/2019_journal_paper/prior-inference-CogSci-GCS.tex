...
Our model builds on the vanilla version of RSA presented above, modifying the listener's state prior $P(s)$ and enhancing the inference process toward social model inference, yielding a full pragmatic social inference RSA model (fPSIRSA). %In that sense, the model belongs to the family of models known as uncertain RSA \cite{goodmanfrank2016}. 
