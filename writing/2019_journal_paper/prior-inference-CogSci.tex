...
nor does optimizing for three parameters \gcs{which three?} \gcs{give the numbers that lead to this conclusion}. %($r^{2}=0.81$).
...
We note that the analyzed preference prior, viewed from a broader perspective, can be interpreted as the general predictive state of mind of the listener when interpreting the speaker's utterance \cite{Butz:2017}. \gcs{I think it would help to expand on this point if we're going to raise it}
