...
where posteriors from previous trials carry over to the next trial as priors. % changed my mind... let's leave it in :-) % sounds good :)
...
% Asya: very true, I hope I can fix one before the GRK days presentation.
