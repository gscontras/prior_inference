...
We model this hypothesis within the Rational Speech Act framework, adding (i) a mechanism that infers listenerâ€™s priors when analyzing their responses to (ambiguous) utterances, and (ii) the ability to choose utterances strategically for maximizing information gain. 
