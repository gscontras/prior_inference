...
We observed a strong positive correlation between the mean rates for $L_1$ feature preferences as judged by human subjects and the model predictions ($r^2 = 0.99, p < 0.001$, Figure \ref{exp1-results}). Mean rates per condition were calculated based on the ambiguity code that we described above. 
